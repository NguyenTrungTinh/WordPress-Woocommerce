                    ...
                    <form id="lwp_login" class="ajax-auth" action="login" style="<?php echo $cclass; ?>" method="post">
                        ...
                        <div class="lwp-form-box">
                            <label class="lwp_labels"
                                   for="lwp_username"><?php echo __('Số điện thoại', $this->textdomain); ?></label>
                            <?php
                            //                    $country_codes = $this->get_country_code_options();
                            ?>
...
//                            $rr=in_array($country["value"],$options['idehweb_country_codes']);
                                ...
                                <input type="number" class="required lwp_username the_lwp_input" name="lwp_username" maxlength="10" minlength="10"
                        ...
                        <button class="submit_button auth_phoneNumber" type="submit">
                            <?php echo __('Đăng nhập', $this->textdomain); ?>
                        </button>
                        <?php
...
//                    }
                ...
                <form id="lwp_activate" class="ajax-auth" action="activate" method="post">
                    <div class="lh1"><?php echo __('Kích hoạt', $this->textdomain); ?></div>
                    <p class="status"></p>
                    <?php wp_nonce_field('ajax-login-nonce', 'security'); ?>
    ...
    function lwp_enter_password_action()
    {
        ...
        if (is_wp_error($user)) {
            ...
            echo json_encode([
                'success' => true,
                'ID' => $user->ID,
                'message' => __('Đang chuyển...', $this->textdomain)
            ]);
